/**
 * InpeImplServiceSoapBindingStub.java
 *
...
public class InpeImplServiceSoapBindingStub extends org.apache.axis.client.Stub implements pe.gob.oefa.interoperabilidad.ws.inpe.service.Inpe {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("getAntecedenteJudicial");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "apepat"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "apemat"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
    ...
    public InpeImplServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public InpeImplServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public InpeImplServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String getAntecedenteJudicial(java.lang.String apepat, java.lang.String apemat, java.lang.String nombres, java.lang.String usuarioOEFA, java.lang.String ip, java.lang.String mcAddress) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://service.inpe.ws.interoperabilidad.oefa.gob.pe/", "getAntecedenteJudicial"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {apepat, apemat, nombres, usuarioOEFA, ip, mcAddress});
