...
public class UtilREST {
	...
	public static String getREST(String uri,String authString, int tipo) throws IOException {

		final int OK = 200;
		URL url = new URL(uri);
		HttpURLConnection connection = (HttpURLConnection) url.openConnection();
		
		connection.setRequestProperty("Authorization", (tipo == 0 ? "Bearer " : "Basic ") + authString);
	...
	public static String postREST(String uri,String rest,String authString, int tipo) throws IOException {
...
//		connection.setFixedLengthStreamingMode(0);
	...
	public static String postREST(String uri,String idUsuario,String idAplicacion,String authString) throws IOException {
		...
		connection.setRequestProperty("Authorization", "Basic " + authString);
		String datajson =  "{\"idUsuario\": \""+idUsuario+"\",\"idAplicacion\": \""+idAplicacion+"\"}";
		OutputStream os = connection.getOutputStream();
		os.write(datajson.getBytes(Constante.UTF_8));
		os.flush();
	...
	public static String postRESTCodUsuario(String uri,String codUsuario, String authString) throws IOException {
		...
		connection.setRequestProperty("Content-Type", MediaType.APPLICATION_JSON_VALUE);
		connection.setRequestProperty("Authorization", "Basic " + authString);
		String datajson =  "{\"codUsuario\": \""+codUsuario+"\"}";
		OutputStream os = connection.getOutputStream();
		os.write(datajson.getBytes(Constante.UTF_8));
		os.flush();
	...
	public static String postRESTPerfil(String uri,String idperfil, String authString) throws IOException {
		...
		connection.setRequestProperty("Content-Type", MediaType.APPLICATION_JSON_VALUE);
		connection.setRequestProperty("Authorization", "Basic " + authString);
		String datajson =  "{\"idPerfil\": \""+idperfil+"\"}";
		OutputStream os = connection.getOutputStream();
		os.write(datajson.getBytes(Constante.UTF_8));
		os.flush();
