...
public class DependienteDTO extends BaseDTO {
	...
	private List<ProgramacionDTO> lstProgramacion;
	private List<PruebaDescarteDTO> lstPruebaDescarte;
	...
	public List<ProgramacionDTO> getLstProgramacion() {
		return lstProgramacion;
	}

	public void setLstProgramacion(List<ProgramacionDTO> lstProgramacion) {
	...
	public List<PruebaDescarteDTO> getLstPruebaDescarte() {
		return lstPruebaDescarte;
	}

	public void setLstPruebaDescarte(List<PruebaDescarteDTO> lstPruebaDescarte) {
