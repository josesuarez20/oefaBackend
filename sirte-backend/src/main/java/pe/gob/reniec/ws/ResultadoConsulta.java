...
public class ResultadoConsulta  implements java.io.Serializable {
    ...
    private pe.gob.reniec.ws.DatosPersona datosPersona;
    ...
    public ResultadoConsulta(
           ...
           pe.gob.reniec.ws.DatosPersona datosPersona,
     ...
     * @return datosPersona
     */
    public pe.gob.reniec.ws.DatosPersona getDatosPersona() {
        return datosPersona;
    }
     ...
     * @param datosPersona
     */
    public void setDatosPersona(pe.gob.reniec.ws.DatosPersona datosPersona) {
        this.datosPersona = datosPersona;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.reniec.gob.pe/", "resultadoConsulta"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.reniec.gob.pe/", "datosPersona"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
