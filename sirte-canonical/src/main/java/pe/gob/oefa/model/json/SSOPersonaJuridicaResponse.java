...
public class SSOPersonaJuridicaResponse implements Serializable{
	...
	private List<RepLegalRequest> RepLegal;
	
	
	public SSOPersonaJuridicaResponse() {
	...
	public List<RepLegalRequest> getRepLegal() {
		return RepLegal;
	}


	public void setRepLegal(List<RepLegalRequest> repLegal) {
		RepLegal = repLegal;
	}
