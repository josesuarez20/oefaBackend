...
public class ControlPosteriorItemRequest implements Serializable {
	...
	private Boolean blDeclaracion;
	private Boolean blAntecedente;
	private BigDecimal arc_observacion;
	
	public ControlPosteriorItemRequest() {
	...
	public Boolean getBlDeclaracion() {
		return blDeclaracion;
	}

	public void setBlDeclaracion(Boolean blDeclaracion) {
		this.blDeclaracion = blDeclaracion;
	}

	public Boolean getBlAntecedente() {
		return blAntecedente;
	}

	public void setBlAntecedente(Boolean blAntecedente) {
		this.blAntecedente = blAntecedente;
	}
