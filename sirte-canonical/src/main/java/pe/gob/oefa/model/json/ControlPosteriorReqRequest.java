...
public class ControlPosteriorReqRequest implements Serializable {
	...
	public ControlPosteriorReqRequest() {
	...
	public Boolean getFlgvalidar() {
		return flgvalidar;
	}

	public void setFlgvalidar(Boolean flgvalidar) {
